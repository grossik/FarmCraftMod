...
public class ContainerBoiling extends Container {
    ...
    private TileEntityBoiling tileFurnace;
    private int lastCookTime;
    private int lastBurnTime;
    private int lastItemBurnTime;

    public ContainerBoiling(InventoryPlayer player, TileEntityBoiling tileEntityFurnace) {
        this.tileFurnace = tileEntityFurnace;
        this.addSlotToContainer(new Slot(tileEntityFurnace, 0, 56, 34));
        this.addSlotToContainer(new Slot(tileEntityFurnace, 1, 26, 34));
        this.addSlotToContainer(new SlotBoiling(player.player, tileEntityFurnace, 2, 116, 35));
        int i;
    ...
    public ItemStack transferStackInSlot(EntityPlayer player, int par2) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (par2 == 2) {
                ...
                if (BoilingRecipes.smelting().getSmeltingResult(itemstack1) != null) {
