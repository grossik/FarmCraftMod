    ...
    public void manipulateTradesForVillager(EntityVillager villager, MerchantRecipeList recipeList, Random random) {
        if (villager.getProfession() == 69699) {
            ...
            for (int sc = 8; sc < 12; sc++) {
                ...
                if (sc == 8) {
                    // adds alumine orebush to the recipe list
                    result = new ItemStack(FarmCraft.BroccoliSeeds, calcStackSize(ingredient, ingredient2), sc);
                    recipeList.addToListWithCheck(new MerchantRecipe(ingredient, ingredient2, result));
                }
                if (sc == 8) {
                    // adds alumine orebush to the recipe list
                    result = new ItemStack(FarmCraft.CabbageSeeds, calcStackSize(ingredient, ingredient2), sc);
                    recipeList.addToListWithCheck(new MerchantRecipe(ingredient, ingredient2, result));
                }
                if (sc == 8) {
                    // adds alumine orebush to the recipe list
                    result = new ItemStack(FarmCraft.CapsicumSeeds, calcStackSize(ingredient, ingredient2), sc);
                    recipeList.addToListWithCheck(new MerchantRecipe(ingredient, ingredient2, result));
                }
                if (sc == 8) {
                    // adds alumine orebush to the recipe list
                    result = new ItemStack(FarmCraft.CucumberSeeds, calcStackSize(ingredient, ingredient2), sc);
                    recipeList.addToListWithCheck(new MerchantRecipe(ingredient, ingredient2, result));
                }
                if (sc == 8) {
                    // adds alumine orebush to the recipe list
                    result = new ItemStack(FarmCraft.RadishSeeds, calcStackSize(ingredient, ingredient2), sc);
                    recipeList.addToListWithCheck(new MerchantRecipe(ingredient, ingredient2, result));
                }
                if (sc == 8) {
                    // adds alumine orebush to the recipe list
                    result = new ItemStack(FarmCraft.RiceSeeds, calcStackSize(ingredient, ingredient2), sc);
                    recipeList.addToListWithCheck(new MerchantRecipe(ingredient, ingredient2, result));
                }
                if (sc == 8) {
                    // adds alumine orebush to the recipe list
                    result = new ItemStack(FarmCraft.TomatoSeeds, calcStackSize(ingredient, ingredient2), sc);
                    recipeList.addToListWithCheck(new MerchantRecipe(ingredient, ingredient2, result));
                }
            }
        }
