...
public class ContainerBottling extends Container {
    ...
    public ContainerBottling(InventoryPlayer player, TileEntityBottling tileEntityFurnace) {
        ...
        this.addSlotToContainer(new SlotBottling(player.player, tileEntityFurnace, 2, 116, 35));
        int i;
    ...
    public ItemStack transferStackInSlot(EntityPlayer player, int par2) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (par2 == 2) {
                ...
                if (BottlingRecipes.smelting().getSmeltingResult(itemstack1) != null) {
