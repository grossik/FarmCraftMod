...
import cze.grossik.farmcraft.wordgen.WorldGenPearTree;
...
public class Block_SaplingPear extends BlockBush implements IGrowable {
    public static final String[] field_149882_a = new String[]{"pear"};
