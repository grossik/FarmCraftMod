...
public class TileEntityMashTun extends TileEntity implements ISidedInventory {
    ...
    public static int getItemBurnTime(ItemStack p_145952_0_) {
        if (p_145952_0_ == null) {
            ...
            if (item == FarmCraft.HotWaterBucket) return 100;
    ...
    public String getInventoryName() {
        return this.hasCustomInventoryName() ? this.field_145958_o : "Mash Tun";
    }
    ...
    public void updateEntity() {
        ...
        if (!this.worldObj.isRemote) {
            ...
            if (flag != this.furnaceBurnTime > 0) {
                flag1 = true;
                Block_MashTun.updateBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
    ...
    private boolean canSmelt() {
        if (this.furnaceItemStacks[0] == null) {
            ...
            ItemStack itemstack = MashTunRecipes.smelting().getSmeltingResult(this.furnaceItemStacks[0]);
