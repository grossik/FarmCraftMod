...
public class WorldGenPearTree extends WorldGenAbstractTree {
    ...
    public WorldGenPearTree(boolean p_i2028_1_, int p_i2028_2_, int p_i2028_3_, int p_i2028_4_, boolean p_i2028_5_) {
        super(p_i2028_1_);
    ...
    public boolean generate(World p_76484_1_, Random p_76484_2_, int p_76484_3_, int p_76484_4_, int p_76484_5_) {
        ...
        if (p_76484_4_ >= 1 && p_76484_4_ + l + 1 <= 256) {
            ...
            if (!flag) {
                ...
                boolean isSoil = block2.canSustainPlant(p_76484_1_, p_76484_3_, p_76484_4_ - 1, p_76484_5_, ForgeDirection.UP, (Block_SaplingPear) BlockHandler.SaplingPear);
                            ...
                            for (int k2 = p_76484_5_ - l1; k2 <= p_76484_5_ + l1; ++k2) {
                                ...
                                if (Math.abs(j2) != l1 || Math.abs(l2) != l1 || p_76484_2_.nextInt(2) != 0 && i3 != 0) {
                                    ...
                                    if (block1.isAir(p_76484_1_, i2, k1, k2) || block1.isLeaves(p_76484_1_, i2, k1, k2)) {
                                        this.setBlockAndNotifyAdequately(p_76484_1_, i2, k1, k2, BlockHandler.leavesPearNormal, this.metaLeaves);
                                        this.setBlockAndNotifyAdequately(p_76484_1_, i2, k1, k2, BlockHandler.leavesPearSH, this.metaLeaves);
