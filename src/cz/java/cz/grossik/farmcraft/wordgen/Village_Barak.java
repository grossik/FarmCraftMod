...
public class Village_Barak extends StructureVillagePieces.Village {
    public Village_Barak() {
    }

    public Village_Barak(StructureVillagePieces.Start p_i2099_1_, int p_i2099_2_, Random p_i2099_3_, StructureBoundingBox p_i2099_4_, int p_i2099_5_) {
        super();
        this.coordBaseMode = p_i2099_5_;
        this.boundingBox = p_i2099_4_;
    }

    public static StructureVillagePieces.Village func_74906_a(StructureVillagePieces.Start p_74906_0_, List p_74906_1_, Random p_74906_2_, int p_74906_3_, int p_74906_4_, int p_74906_5_, int p_74906_6_, int p_74906_7_) {
        ...
        return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_74906_1_, structureboundingbox) == null ? new Village_Barak(p_74906_0_, p_74906_7_, p_74906_2_, structureboundingbox, p_74906_6_) : null;
    }
    ...
    public boolean addComponentParts(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
        ...
        this.fillWithBlocks(p_74875_1_, p_74875_3_, 2, 0, 6, 8, 0, 10, Blocks.farmland, Blocks.farmland, false);

        this.fillWithBlocks(p_74875_1_, p_74875_3_, 2, 1, 6, 8, 1, 10, BlockHandler.StrawberryBlock, Blocks.dirt, false);
        this.fillWithBlocks(p_74875_1_, p_74875_3_, 2, 1, 7, 8, 1, 10, BlockHandler.StrawberryBlock, Blocks.dirt, false);
        this.fillWithBlocks(p_74875_1_, p_74875_3_, 2, 1, 8, 8, 1, 10, BlockHandler.BlueberryBlock, Blocks.dirt, false);
        this.fillWithBlocks(p_74875_1_, p_74875_3_, 2, 1, 9, 8, 1, 10, BlockHandler.BlueberryBlock, Blocks.dirt, false);
        ...
        this.placeBlockAtCurrentPosition(p_74875_1_, Blocks.water, 0, 5, 0, 5, p_74875_3_);
