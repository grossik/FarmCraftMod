...
public class TileEntityBottling extends TileEntity implements ISidedInventory {
    ...
    public static int getItemBurnTime(ItemStack p_145952_0_) {
        if (p_145952_0_ == null) {
            ...
            if (item == ItemHandler.Bottle) return 50;
    ...
    public void field_145958_o(String displayName) {
    ...
    public String getInventoryName() {
        return this.hasCustomInventoryName() ? this.field_145958_o : "Bottling";
    }
    ...
    public int getCookProgressScaled(int p_145953_1_) {
        return this.furnaceCookTime * p_145953_1_ / 50;
    }
    ...
    public void updateEntity() {
        ...
        if (!this.worldObj.isRemote) {
            ...
            if (flag != this.furnaceBurnTime > 0) {
                flag1 = true;
                Block_Bottling.updateBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
    ...
    private boolean canSmelt() {
        if (this.furnaceItemStacks[0] == null) {
            ...
            ItemStack itemstack = BottlingRecipes.smelting().getSmeltingResult(this.furnaceItemStacks[0]);
