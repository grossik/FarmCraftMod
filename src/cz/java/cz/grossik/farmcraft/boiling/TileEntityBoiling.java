...
public class TileEntityBoiling extends TileEntity implements ISidedInventory {
    ...
    public String getInventoryName() {
        return this.hasCustomInventoryName() ? this.field_145958_o : "Boiling";
    }
    ...
    public void updateEntity() {
        ...
        if (!this.worldObj.isRemote) {
            ...
            if (flag != this.furnaceBurnTime > 0) {
                flag1 = true;
                Block_Boiling.updateBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
    ...
    private boolean canSmelt() {
        if (this.furnaceItemStacks[0] == null) {
            ...
            ItemStack itemstack = BoilingRecipes.smelting().getSmeltingResult(this.furnaceItemStacks[0]);
