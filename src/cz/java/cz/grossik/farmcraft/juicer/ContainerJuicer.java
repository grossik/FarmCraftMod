...
public class ContainerJuicer extends Container {
    ...
    public ContainerJuicer(InventoryPlayer player, TileEntityJuicer tileEntityFurnace) {
        ...
        this.addSlotToContainer(new SlotJuicer(player.player, tileEntityFurnace, 2, 116, 35));
        int i;
    ...
    public ItemStack transferStackInSlot(EntityPlayer player, int par2) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (par2 == 2) {
                ...
                if (JuicerRecipes.smelting().getSmeltingResult(itemstack1) != null) {
