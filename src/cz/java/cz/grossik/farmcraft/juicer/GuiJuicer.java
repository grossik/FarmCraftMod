...
public class GuiJuicer extends GuiContainer {
    ...
    private static final ResourceLocation furnaceGuiTextures = new ResourceLocation("farmcraft:textures/gui/container/juicer.png");
    private TileEntityJuicer tileFurnace;

    public GuiJuicer(InventoryPlayer invPlayer, TileEntityJuicer tile) {
        super(new ContainerJuicer(invPlayer, tile));
