...
public class TileEntityJuicer extends TileEntity implements ISidedInventory {
    ...
    public static int getItemBurnTime(ItemStack p_145952_0_) {
        if (p_145952_0_ == null) {
            ...
            if (item == ItemHandler.Glass) return 70;
    ...
    public String getInventoryName() {
        return this.hasCustomInventoryName() ? this.field_145958_o : "Juicer";
    }
    ...
    public int getCookProgressScaled(int p_145953_1_) {
        return this.furnaceCookTime * p_145953_1_ / 70;
    }
    ...
    public void updateEntity() {
        ...
        if (!this.worldObj.isRemote) {
            ...
            if (flag != this.furnaceBurnTime > 0) {
                flag1 = true;
                Block_Juicer.updateBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
    ...
    private boolean canSmelt() {
        if (this.furnaceItemStacks[0] == null) {
            ...
            ItemStack itemstack = JuicerRecipes.smelting().getSmeltingResult(this.furnaceItemStacks[0]);
