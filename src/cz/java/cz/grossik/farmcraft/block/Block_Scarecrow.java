...
public class Block_Scarecrow extends Block {
    ...
    public Item getItemDropped(int p_149650_1_, Random p_149650_2_, int p_149650_3_) {
        return (p_149650_1_ & 8) != 0 ? null : (this.blockMaterial == Material.iron ? ItemHandler.ScarecrowItem : ItemHandler.ScarecrowItem);
    }
    ...
    public Item getItem(World p_149694_1_, int p_149694_2_, int p_149694_3_, int p_149694_4_) {
        return this.blockMaterial == Material.iron ? ItemHandler.ScarecrowItem : ItemHandler.ScarecrowItem;
    }
