...
public class Block_LeavesCherryST extends Block_Leaves {
    public static final String[][] field_150130_N = new String[][]{{"farmcraft:leaves_withcherry"}, {"farmcraft:leaves_withcherry_opaque"}};
    public static final String[] field_150131_O = new String[]{"withcherry"};
    private static final String __OBFID = "CL_00000280";
    private int iconType;

    public Block_LeavesCherryST() {
        super();
    }
    ...
    public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_) {
        ...
        if (!p_149674_1_.isRemote) {
            if (p_149674_1_.getBlockLightValue(p_149674_2_, p_149674_3_ + 1, p_149674_4_) < 4 && p_149674_1_.getBlockLightOpacity(p_149674_2_, p_149674_3_ + 1, p_149674_4_) > 2) {
                p_149674_1_.setBlock(p_149674_2_, p_149674_3_, p_149674_4_, BlockHandler.leavesCherryNormal);
                ...
                for (int l = 0; l < 4; ++l) {
                    ...
                    if (p_149674_1_.getBlock(i1, j1, k1) == BlockHandler.leavesCherryNormal && p_149674_1_.getBlockMetadata(i1, j1, k1) == 0 && p_149674_1_.getBlockLightValue(i1, j1 + 1, k1) >= 4 && p_149674_1_.getBlockLightOpacity(i1, j1 + 1, k1) <= 2) {
                        p_149674_1_.setBlock(i1, j1, k1, BlockHandler.leavesCherryST);
                    }
                }
            }
        }
    ...
    public boolean setBlockPear(World par1World, int par2, int par3, int par4) {
        return par1World.setBlock(par2, par3, par4, BlockHandler.leavesCherryNormal);
    }

    public void onBlockClicked(World par1World, int par2, int par3, int par4, EntityPlayer p5EP) {
        EntityItem entityitem = new EntityItem(par1World, p5EP.posX, p5EP.posY - 1.0D, p5EP.posZ, new ItemStack(ItemHandler.Cherry, 1, 2));
