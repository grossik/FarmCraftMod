package cz.grossik.farmcraft.mashtun;
...
public class ContainerMashTun extends Container {
    ...
    private TileEntityMashTun tileFurnace;
    private int lastCookTime;
    private int lastBurnTime;
    private int lastItemBurnTime;

    public ContainerMashTun(InventoryPlayer player, TileEntityMashTun tileEntityFurnace) {
        ...
        this.addSlotToContainer(new SlotMashTun(player.player, tileEntityFurnace, 2, 116, 35));
        int i;
    ...
    public ItemStack transferStackInSlot(EntityPlayer player, int par2) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (par2 == 2) {
                ...
                if (MashTunRecipes.smelting().getSmeltingResult(itemstack1) != null) {
