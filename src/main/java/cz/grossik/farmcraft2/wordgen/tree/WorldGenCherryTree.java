...
public class WorldGenCherryTree extends WorldGenAbstractTree
{
    ...
    private static final IBlockState field_181654_b = BlockHandler.leavesCherryNormal.getDefaultState();
    ...
    public WorldGenCherryTree(boolean p_i46446_1_, int p_i46446_2_, IBlockState p_i46446_3_, IBlockState p_i46446_4_, boolean p_i46446_5_)
    {
        super(p_i46446_1_);
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position)
    {
        ...
        if (position.getY() >= 1 && position.getY() + i + 1 <= worldIn.getHeight())
        {
            ...
            else
            {
                ...
                if (state.getBlock().canSustainPlant(state, worldIn, position.down(), net.minecraft.util.EnumFacing.UP, (cz.grossik.farmcraft2.block.sapling.Block_SaplingCherry)BlockHandler.SaplingCherry) && position.getY() < worldIn.getHeight() - i - 1)
                {
