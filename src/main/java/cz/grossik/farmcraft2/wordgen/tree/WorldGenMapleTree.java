...
{
    private static final IBlockState field_181653_a = BlockHandler.MapleWood.getDefaultState();
    private static final IBlockState field_181654_b = BlockHandler.MapleLeaves.getDefaultState();
    ...
    public WorldGenMapleTree(boolean p_i2027_1_)
    {
        this(p_i2027_1_, 4, field_181653_a, field_181654_b, false);
    }

    public WorldGenMapleTree(boolean p_i46446_1_, int p_i46446_2_, IBlockState p_i46446_3_, IBlockState p_i46446_4_, boolean p_i46446_5_)
    {
        super(p_i46446_1_);
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position)
    {
        ...
        if (position.getY() >= 1 && position.getY() + i + 1 <= worldIn.getHeight())
        {
            ...
            else
            {
                ...
                if (state.getBlock().canSustainPlant(state, worldIn, position.down(), net.minecraft.util.EnumFacing.UP, (cz.grossik.farmcraft2.block.sapling.BlockSaplingMaple)BlockHandler.SaplingMaple) && position.getY() < worldIn.getHeight() - i - 1)
                {
