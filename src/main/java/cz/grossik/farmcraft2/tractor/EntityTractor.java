...
enum Type
{
    VEHICLE("tractor", null, null, null, null);
...
public class EntityTractor extends EntityLiving implements IInventoryChangedListener, IJumpingMount
{
    private static final Predicate<Entity> IS_HORSE_BREEDING = new Predicate<Entity>()
    {
        public boolean apply(@Nullable Entity p_apply_1_)
        {
            return p_apply_1_ instanceof EntityTractor && ((EntityTractor)p_apply_1_).isBreeding();
        }
    };
    private static final DataParameter<Byte> STATUS = EntityDataManager.<Byte>createKey(EntityTractor.class, DataSerializers.BYTE);
    private static final DataParameter<Integer> TYPE = EntityDataManager.<Integer>createKey(EntityTractor.class, DataSerializers.VARINT);
    ...
    protected void playStepSound(BlockPos pos, Block blockIn)
    {
        ...
        if (!blockIn.getDefaultState().getMaterial().isLiquid())
        {
            ...
            if (this.isBeingRidden())
            {
                ...
                {
                    this.playSound(FC2Sounds.tractor, soundtype.getVolume() * 0.15F, soundtype.getPitch());
    ...
    protected EntityTractor getClosestHorse(Entity entityIn, double distance)
    {
    ...
    {
        this.dropItem(ItemHandler.ItemTractor, 1);
    }
    ...
    public void onLivingUpdate()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                EntityTractor entityhorse = this.getClosestHorse(this, 16.0D);
