...
public class Block_LeavesPlumSS extends BlockLeaves {
    ...
    public boolean setBlockPear(World par1World, BlockPos pos) {
        return par1World.setBlockState(pos, BlockHandler.leavesPlumNormal.getDefaultState());
    }

    public void onBlockClicked(World worldIn, BlockPos pos, EntityPlayer playerIn) {
        EntityItem entityitem = new EntityItem(worldIn, playerIn.posX, playerIn.posY - 1.0D, playerIn.posZ, new ItemStack(ItemHandler.Plum));
