...
public abstract class JuicerRecipeCategory extends BlankRecipeCategory {
	...
	public JuicerRecipeCategory(IGuiHelper guiHelper) {
		backgroundLocation = new ResourceLocation("farmcraft2", "textures/gui/container/juicer.png");
		...
		this.arrow = guiHelper.createAnimatedDrawable(arrowDrawable, 70, IDrawableAnimated.StartDirection.LEFT, false);
	}
	
	public static void register(IModRegistry registry, IGuiHelper guiHelper) {
		registry.addRecipeClickArea(GuiJuicer.class, 80, 35, 22, 15, "juiceroff");
	}
}