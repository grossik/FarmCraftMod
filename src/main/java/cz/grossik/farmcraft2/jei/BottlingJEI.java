...
public class BottlingJEI
{
  ...
  static public class Wrapper implements IRecipeWrapper
  {
    ...
    public Wrapper(IJeiHelpers helpers,@Nonnull List<List<ItemStack>> input, List<ItemStack> output)
    {
      ...
      ResourceLocation furnaceBackgroundLocation = new ResourceLocation("farmcraft2", "textures/gui/container/bottling.png");
  ...
  static public class Category implements IRecipeCategory
  {
    ...
    public Category(IJeiHelpers helpers)
    {
      ...
      IGuiHelper guiHelper = helpers.getGuiHelper();
      background_location = new ResourceLocation("farmcraft2", "textures/gui/container/bottling.png");

      IDrawableStatic arrowDrawable = guiHelper.createDrawable(background_location, 176, 14, 24, 17);
      arrow = guiHelper.createAnimatedDrawable(arrowDrawable, 200, IDrawableAnimated.StartDirection.LEFT, false);

      ResourceLocation location = new ResourceLocation("farmcraft2", "textures/gui/container/bottling.png");
    ...
    public void setRecipe(@Nonnull IRecipeLayout recipeLayout, @Nonnull IRecipeWrapper recipeWrapper)
    {
      ...
      gui_items.init(0, true, 25, 0);
      gui_items.init(1, true, 25, 36);
  ...
  static public List<Wrapper> getRecipes(IJeiHelpers helpers)
  {
    ...
    for(IBottlingRecipe recipe : BottlingRecipeManager.instance.getRecipes())
    {
