...
public class TileEntityBoiling extends TileEntityLockable implements ITickable, ISidedInventory
{
    ...
    {
        return this.hasCustomName() ? this.furnaceCustomName : "Boiling";
    }
    ...
    public void update()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                Block_Boiling.setState(this.isBurning(), this.worldObj, this.pos);
            }
        }
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack itemstack = BoilingRecipes.instance().getSmeltingResult(this.furnaceItemStacks[0]);
    ...
    public boolean isItemValidForSlot(int index, ItemStack stack)
    {
        ...
        else
        {
            ...
            return isItemFuel(stack) || SlotBoilingFuel.isBucket(stack) && (itemstack == null || itemstack.getItem() != Items.bucket);
        }
    }
    ...
    {
        return new ContainerBoiling(playerInventory, this);
    }
