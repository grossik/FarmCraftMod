...
public class GuiCrushing extends GuiContainer
{
    ...
    public GuiCrushing(InventoryPlayer playerInv, TileEntityCrushing furnaceInv)
    {
        super(new ContainerCrushing(playerInv, furnaceInv));
