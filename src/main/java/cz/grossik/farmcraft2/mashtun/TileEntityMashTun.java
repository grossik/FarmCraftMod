...
public class TileEntityMashTun extends TileEntityLockable implements ITickable, ISidedInventory
{
    ...
    {
        return this.hasCustomName() ? this.furnaceCustomName : "Mash Tun";
    }
    ...
    public void update()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                Block_MashTun.setState(this.isBurning(), this.worldObj, this.pos);
            }
        }
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack itemstack = MashTunRecipes.instance().getSmeltingResult(this.furnaceItemStacks[0]);
    ...
    {
        return new ContainerMashTun(playerInventory, this);
    }
