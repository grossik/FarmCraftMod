...
public class FermentingBarrelRecipes
{
    private static final FermentingBarrelRecipes smeltingBase = new FermentingBarrelRecipes();
     ...
     */
    public static FermentingBarrelRecipes instance()
    {
        return smeltingBase;
    }
    ...
    private FermentingBarrelRecipes()
    {
        ...
        this.addSmelting(ItemHandler.ColdWorts, new ItemStack(ItemHandler.BeerBucket), 0.0F);
    }
