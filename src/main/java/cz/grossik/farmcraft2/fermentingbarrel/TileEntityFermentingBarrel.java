...
public class TileEntityFermentingBarrel extends TileEntityLockable implements ITickable, ISidedInventory
{
    ...
    {
        return this.hasCustomName() ? this.furnaceCustomName : "Fermenting Barrel";
    }
    ...
    public void update()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                Block_FermentingBarrel.setState(this.isBurning(), this.worldObj, this.pos);
            }
        }
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack itemstack = FermentingBarrelRecipes.instance().getSmeltingResult(this.furnaceItemStacks[0]);
    ...
    {
        return new ContainerFermentingBarrel(playerInventory, this);
    }
