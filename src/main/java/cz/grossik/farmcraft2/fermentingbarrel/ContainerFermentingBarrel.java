...
public class ContainerFermentingBarrel extends Container
{
    ...
    public ContainerFermentingBarrel(InventoryPlayer playerInventory, TileEntityFermentingBarrel te)
    {
        this.tileFurnace = te;
        this.addSlotToContainer(new SlotFermentingBarrel(te, 0, 56, 17));
        this.addSlotToContainer(new SlotFermentingBarrelFuel(te, 1, 56, 53));
        this.addSlotToContainer(new SlotFermentingBarrelOutput(playerInventory.player, te, 2, 116, 35));
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            {
                if (FermentingBarrelRecipes.instance().getSmeltingResult(itemstack1) != null)
                {
                ...
                else if (TileEntityFermentingBarrel.isItemFuel(itemstack1))
                {
