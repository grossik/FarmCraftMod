...
public class GuiButtonSpigot extends GuiButton
{
  ...
  public GuiButtonSpigot(int id, int x, int y,int w,int h,ResourceLocation texture,int tex_x,int tex_y,int tex_mo_x,int tex_mo_y)
  {
    super(id, x, y, w, h, "");
    texture_x = tex_x;
    texture_y = tex_y;
  ...
  public GuiButtonSpigot setIconTexture(int x, int y,int w,int h)
  {
    icon_x = x;
    icon_y = y;
    icon_width = w;
