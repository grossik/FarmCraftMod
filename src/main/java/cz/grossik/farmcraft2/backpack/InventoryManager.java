...
{
    private static final String StorageKey = "Backpack";
    ...
    public BackpackInventory getInventory(int id)
    {
    ...
    {
        private Map<Integer, BackpackInventory> inventories = new HashMap<Integer, BackpackInventory>();

        public BackpackInventory getInventory(int id)
        {
            BackpackInventory inventory = inventories.get(id);

            if (inventory == null)
            {
                inventory = new BackpackInventory(this);
        ...
        public NBTTagCompound serializeNBT()
        {
            ...
            for (Map.Entry<Integer, BackpackInventory> entry : this.inventories.entrySet())
            {
        ...
        public void deserializeNBT(NBTTagCompound nbt)
        {
            ...
            for (int i = 0; i < nbtTagList.tagCount(); ++i)
            {
                ...
                BackpackInventory inventory = new BackpackInventory(this);
