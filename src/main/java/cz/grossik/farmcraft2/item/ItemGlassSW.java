...
public class ItemGlassSW extends ItemFood{
    ...
    public ItemStack onItemUseFinish(ItemStack stack, World worldIn, EntityLivingBase entityLiving)
    {
        ...
        if (entityLiving instanceof EntityPlayer)
        {
            ...
            if (entityplayer == null || !entityplayer.capabilities.isCreativeMode)
            {
                ...
                {
                    return new ItemStack(ItemHandler.GlassFW);
                }

                if (entityplayer != null)
                {
                    entityplayer.inventory.addItemStackToInventory(new ItemStack(ItemHandler.GlassFW));
                }
            }
        }
	...
	protected void onFoodEaten(ItemStack itemStack, World world, EntityPlayer entity){
	    super.onFoodEaten(itemStack, world, entity);
	        ...
	        if (!world.isRemote)
	        	entity.addPotionEffect(new PotionEffect(MobEffects.NAUSEA, 300, 3));	   
