...
public class ContainerPan extends Container
{
    ...
    public ContainerPan(InventoryPlayer playerInventory, TileEntityPan te)
    {
        this.tileFurnace = te;
        this.addSlotToContainer(new SlotPan(te, 0, 57, 35));
        this.addSlotToContainer(new SlotPanOutput(playerInventory.player, te, 2, 116, 35));
