...
{
    private static final PanRecipes smeltingBase = new PanRecipes();
     ...
     */
    public static PanRecipes instance()
    {
        return smeltingBase;
    }
    ...
    private PanRecipes()
    {
        this.addSmelting(ItemHandler.DfPancakes, new ItemStack(ItemHandler.Pancakes, 1), 0.0F);
    }
